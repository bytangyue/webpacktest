...
module.exports = {
    ...
    output: {//打包输出
        ...
        publicPath: 'http://127.0.0.1:8080/assets/'//网站运行时的路径。【创建文件引用的文件路径】
    },
    module: {
        ...
        loaders: [//【-loader可以省略，!表示用并且的关系】
            ...
            {test: /.(png|jpg)$/, loader: 'url?limit=8192&name=[path][hash].[ext]'}//assets目录下会生成1个图片打包文件,&name=[path][hash].[ext]解决了图片打包后url不对的问题
        ]
    },
